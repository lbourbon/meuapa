...
class Ficha(models.Model):
    ...
    peso = models.DecimalField(decimal_places=2, max_digits=5, null=True, blank=True)
    altura = models.DecimalField(decimal_places=2, max_digits=5, null=True, blank=True)
    ...
    hb = models.DecimalField(decimal_places=2, max_digits=8, null=True, blank=True)
    ht = models.DecimalField(decimal_places=2, max_digits=8, null=True, blank=True)
    leuco = models.DecimalField(decimal_places=2, max_digits=8, null=True, blank=True)
    plt = models.DecimalField(decimal_places=2, max_digits=8, null=True, blank=True)
    gli = models.DecimalField(decimal_places=2, max_digits=8, null=True, blank=True)
    u = models.DecimalField(decimal_places=2, max_digits=8, null=True, blank=True)
    cr = models.DecimalField(decimal_places=2, max_digits=8, null=True, blank=True)
    na = models.DecimalField(decimal_places=2, max_digits=8, null=True, blank=True)
